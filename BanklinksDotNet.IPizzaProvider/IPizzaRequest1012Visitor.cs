...
namespace BanklinksDotNet.IPizzaProvider
{
    ...
    public class IPizzaRequest1012Visitor : AbstractRequestVisitor<BankRequest, IPizzaPaymentRequestParams, IPizzaConfiguration>
    {
        private readonly IPizzaMessageMapper _bankMessageMapper;

        public IPizzaRequest1012Visitor(IGlobalConfiguration globalConfiguration, IPizzaMessageMapper bankMessageMapper)
        ...
        {
            return string.IsNullOrEmpty(requestParams.RecipientName) || string.IsNullOrEmpty(requestParams.RecipientAccountNumber);
        }
        ...
        protected override BankRequest ParseResult(IPizzaPaymentRequestParams visitable, IPizzaConfiguration bankConfiguration)
        {
            ...
            {
                new BankMessageField { OrderNr = 1, FieldName = "VK_SERVICE", MaxLength = 4, Value = "1012" },
                ...
                new BankMessageField { OrderNr = 7, FieldName = "VK_REF", MaxLength = 35, Value = visitable.PaymentReferenceNumber },
                new BankMessageField { OrderNr = 8, FieldName = "VK_MSG", MaxLength = 95, Value = visitable.PaymentMessage },
                new BankMessageField { OrderNr = 9, FieldName = "VK_RETURN", MaxLength = 255, Value = visitable.SuccessReturnUrl },
                new BankMessageField { OrderNr = 10, FieldName = "VK_CANCEL", MaxLength = 255, Value = visitable.ErrorReturnUrl },
                new BankMessageField { OrderNr = 11, FieldName = "VK_DATETIME", MaxLength = 24, Value = visitable.RequestStartDateTime.ToString(bankConfiguration.DateTimeFormat) },
