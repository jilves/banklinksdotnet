...
namespace BanklinksDotNet.IPizzaProvider
{
    ...
    public class IPizzaRequest4011Visitor : AbstractRequestVisitor<BankRequest, IPizzaAuthRequestParams, IPizzaConfiguration>
    {
        private readonly IPizzaMessageMapper _bankMessageMapper;

        public IPizzaRequest4011Visitor(IGlobalConfiguration globalConfiguration, IPizzaMessageMapper bankMessageMapper)
        ...
        {
            return requestParams.ExpectedReturnCode == "3012";
        }
        ...
        protected override BankRequest ParseResult(IPizzaAuthRequestParams visitable, IPizzaConfiguration bankConfiguration)
        {
            ...
            {
                new BankMessageField { OrderNr = 1, FieldName = "VK_SERVICE", MaxLength = 4, Value = "4011" },
                ...
                new BankMessageField { OrderNr = 4, FieldName = "VK_REPLY", MaxLength = 4, Value = visitable.ExpectedReturnCode },
                new BankMessageField { OrderNr = 5, FieldName = "VK_RETURN", MaxLength = 255, Value = visitable.ReturnUrl },
                new BankMessageField { OrderNr = 6, FieldName = "VK_DATETIME", MaxLength = 24, Value = visitable.RequestStartDateTime.ToString(bankConfiguration.DateTimeFormat) },
                new BankMessageField { OrderNr = 7, FieldName = "VK_RID", MaxLength = 30, Value = visitable.RequestId },
