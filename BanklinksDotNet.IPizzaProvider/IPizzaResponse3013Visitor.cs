...
namespace BanklinksDotNet.IPizzaProvider
{
    ...
    public class IPizzaResponse3013Visitor : AbstractResponseVisitor<AbstractBankResponse, VisitableNameValueCollection, IPizzaConfiguration>
    {
        private readonly IPizzaMessageMapper _bankMessageMapper;

        public IPizzaResponse3013Visitor(IGlobalConfiguration globalConfiguration, IPizzaMessageMapper bankMessageMapper)
        ...
        protected override AbstractBankResponse ParseResult(VisitableNameValueCollection visitable, IPizzaConfiguration bankConfiguration)
        {
            var bankAuthResponse = new List<BankMessageField>
            {
                ...
                new BankMessageField { OrderNr = 3, FieldName = "VK_DATETIME", MaxLength = 24 },
                new BankMessageField { OrderNr = 4, FieldName = "VK_SND_ID", MaxLength = 15 },
                new BankMessageField { OrderNr = 5, FieldName = "VK_REC_ID", MaxLength = 15, },
                new BankMessageField { OrderNr = 6, FieldName = "VK_NONCE", MaxLength = 50 },
